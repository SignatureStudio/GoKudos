  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 -my-6 -mx-5">
        <div className="col-span-2 overflow-auto border-b md:h-screen md:max-h-96 md:border-r md:border-b-0 border-gray-200">
          <div className="p-1">
            <div className="">
              <label>
                {/* <div>Task name</div> */}
        ...
        <div className="col-span-1 overflow-auto md:h-screen md:max-h-96 p-2 bg-gray-100">
          <div className="border border-gray-200 rounded divide-y divide-gray-200 bg-white">
            ...
            <div className="px-2 py-3 flex">
              <div className="w-28">Timeline</div>
              <div className="flex-1">
                <InputTimeline data={{}} />
              </div>
            </div>
            ...
            <div className="px-2 py-3 flex">
              <div className="w-28">Watchers</div>
              <div className="flex-1">
                <InputSelectMember data={[]} />
              </div>
            </div>
            <div className="px-2 py-3 flex">
              <div className="w-28">Contacts</div>
              <div className="flex-1">
                <InputSelectMember data={[]} />
              </div>
            </div>
            <div className="px-2 py-3 flex">
              <div className="w-28">Tracking</div>
              <div className="flex-1">
                <InputTracking data={{}} />
              </div>
            </div>
            ...
            <div className="px-2 py-3 flex">
              <div className="w-28">Project value</div>
              <div className="flex-1">
                <InputText data={null} prefix="RM " placeholder="RM" />
              </div>
            </div>
            <div className="px-2 py-3 flex">
              <div className="w-28">Planned effort</div>
              <div className="flex-1">
                <InputText data={null} suffix=" hours" placeholder="Hours" />
              </div>
            </div>
            <div className="px-2 py-3 flex">
              <div className="w-28">Reminder</div>
              <div className="flex-1">
                <InputReminder data={null} />
              </div>
            </div>
            <div className="px-2 py-3 flex">
              <div className="w-28">Recurrence</div>
              <div className="flex-1">
